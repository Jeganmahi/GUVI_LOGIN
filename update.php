...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT photo FROM login WHERE email='$s'";
    ...
    if (move_uploaded_file($file_tmp, $filePath)) {
        ...
        $query = "UPDATE login SET photo='$filePath',name='$name', age='$age', dob='$dob', phonenumber='$phone',address='$address',gender='$gender' WHERE email='$s'";
